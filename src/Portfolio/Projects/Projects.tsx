...
import { CardTags } from "./ProjectCard/ProjectCard.tsx";
        ...
        <div class="list">
            <ProjectSection
                ...
                projects={[{
                    ...
                    tags: [ CardTags.HTML5, CardTags.ZeroDependencies, CardTags.TypeScript ]
                }, {
                    icon: <CubesIcon />,
                    title: "iso-bench",
                    ...
                    icon: <MinimizeIcon />,
                    title: "bitpack",
                    description: ["Library to serialize data to the minimum representable bit possible following a schema, reducing serialization size and improving performance.", "Faster than protobuf.js and with smaller payload results."],
                    tags: [ CardTags.NodeJS, CardTags.ZeroDependencies, CardTags.TypeScript ]
                }, {
                    icon: <TwoArrowsIcon />,
                    title: "pacopack",
                    repo: "Llorx/pacopack",
                    description: "Library to serialize schemaless data but faster than JSON native methods.",
                    links: [{
                    ...
                    icon: <DatabaseIcon />,
                    title: "realtime-lmdb",
                    description: "Wrapper over LMDB to have a super duper blazing fast realtime key-store database, with built-in subscriptions over WebSockets to connect the realtime database directly to the browser.",
                    tags: [ CardTags.NodeJS, CardTags.TypeScript, CardTags.CPP ]
                }, {
                    icon: <PencilIcon />,
                    title: "flash-canvas",
                    description: "I loved Macromedia Flash back in the day, so when it was deprecated, I built my own HTML5 canvas engine with the same spirit: frames, animations, vectors, interactivity...",
                    tags: [ CardTags.HTML5, CardTags.ZeroDependencies, CardTags.JavaScript ]
                }]}
            />
            <ProjectSection
                class="tools"
                ...
                projects={[{
                    ...
                    tags: [ CardTags.NodeJS, CardTags.HTML5, CardTags.TypeScript ]
                }, {
                    icon: <PhoneIcon />,
                    title: "voip-central",
                    ...
                    tags: [ CardTags.NodeJS, CardTags.HTML5, CardTags.ZeroDependencies, CardTags.TypeScript ]
                }, {
                    icon: <VideoIcon />,
                    title: "liveu-manager",
            ...
            <ProjectSection
                ...
                projects={[{
                    ...
                    tags: [ CardTags.Flash, CardTags.NodeJS, CardTags.TypeScript, CardTags.Ruby, CardTags.CPP, CardTags.HTML5 ]
                }, {
                    icon: <TabIcon />,
                    title: "Alter Tap",
                    description: "Small skill game where you have to tap the screen alternativaly (or arrow keys) to skip through obstacles.",
                    links: [{
                        label: "Game on Kongregate",
                        link: "https://www.kongregate.com/en/games/Llorx/alter-tap"
                    }],
                    tags: [ CardTags.Unity ]
                }, {
                    icon: <BasketballIcon />,
            ...
            <ProjectSection
                ...
                projects={[{
                    ...
                    links: [{
                        label: "My Codementor profile",
                        link: "https://www.codementor.io/@llorx"
                    }]
                }, {
                    icon: <SatelliteIcon />,
